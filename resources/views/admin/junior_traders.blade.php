...
<title>List of Junior Traders</title>

@section('page-header')
    <h3>List of Junior Traders</h3>
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header card-header-primary" style="background:#E2A921;">
                    <div class="card-title" style="color:#000;"><h4>All registered Junior Traders</h4></div>
                </div>

                <div class="card-body">
                    <div>
                        <a href="{{ url('/admin/traders_export/2') }}"><button class="btn btn-secondary">Export List</button></a>
                    </div>
                    @isset($_GET['msg'])
